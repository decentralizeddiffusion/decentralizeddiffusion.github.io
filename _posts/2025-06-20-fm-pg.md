...
<div style="text-align: center; margin-bottom: 20px;">
  <a href="https://mcallisterdavid.com/" style="text-decoration: none; margin: 0 10px; font-weight: bold;">
    David McAllister*
  </a>
  <a href="https://songweige.github.io" style="text-decoration: none; margin: 0 10px; font-weight: bold;">
    Songwei Ge*
  </a>
  <a href="https://brentyi.github.io/" style="text-decoration: none; margin: 0 10px; font-weight: bold;">
    Brent Yi*
  </a>
  ...
  <a href="https://hongsukchoi.github.io/" style="text-decoration: none; margin: 0 10px; font-weight: bold;">
    Hongsuk Choi
  </a>
...
Geometrically, the marginal flow points to a *weighted-average* of the data where the weights are a function of the timestep and distance from $x_t$ to each data point. You can see the particles follow the marginal flow in the plot above when stochasticity is turned off. Stated simply, flow matching aligns the marginal flow to point to the data.
...
From the rewards, we calculate advantages. These can be viewed as the reward normalized *w.r.t.* the expected reward from the rest of the rollout under the current policy. This is why you train a value function in PPO or take the average of a group's reward in GRPO.
...
<div class="l-body" style="text-align: center; margin-top: -0%; margin-bottom: 2%;">
 ...
 Given the advantages, train the model on that data point with a gradient update scaled by the advantage. So, if the advantage is negative, it will become less likely. Postive advantage, more likely.
